...
class reclassify_CCAP_wetlands(object):
    ...
    def execute(self, parameters, messages):
        ...
        if ".tif" not in reclass_start:
            arcpy.AddWarning("Consider adding .tif extension to both outputs.")
        elif ".tif" not in reclass_end:
            arcpy.AddWarning("Consider adding .tif extension to both outputs.")
...
class Plus(object):
    ...
    def execute(self, parameters, messages):
        ...
        if ".tif" not in output:
            arcpy.AddWarning("Consider adding .tif extension to output.")
